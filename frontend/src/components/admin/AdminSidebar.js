...
// import { Button } from "../citizen/ui/button"; // ✅ Adjust path based on your project
// import { cn } from "../citizen/lib/utils";  // ✅ Adjust path if needed
...
//             <p className="text-xs text-muted-foreground">admin@smartwaste.com</p>
//           </div>
//         </div>
//       </div>
//     </div>
    ...
    <div className="w-64 bg-sidebar border-r border-sidebar-border flex flex-col">
      ...
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-sidebar-foreground">SmartWaste</h2>
            <p className="text-xs text-muted-foreground">Admin Panel</p>
          </div>
        </div>
      </div>
