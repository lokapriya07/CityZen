...
export default function TaskQueue({ tasks, onStatusUpdate }) {
  ...
  return (
    <LoadScript googleMapsApiKey="AIzaSyAPP42GnMa7iEt2DK5ydQJJbUfEPlPZsR4">
            ...
            <div key={task.id} className="bg-white shadow rounded overflow-hidden">
              ...
              <div className="p-4 space-y-4 grid md:grid-cols-2 gap-4 items-center">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2 mt-2">
                    <button onClick={() => handleNavigate(task)} className="flex items-center gap-1 px-3 py-1 border rounded text-sm hover:bg-gray-100">
                      <Navigation className="h-4 w-4" /> Navigate
                    </button>
                    <button onClick={() => handleCallSupport(task.supportNumber)} className="flex items-center gap-1 px-3 py-1 border rounded text-sm hover:bg-gray-100">
              ...
              {nextAction && (
                <div className="p-4 border-t flex justify-end">
                  <button onClick={() => handleActionClick(task.id, nextAction.nextStatus)} className="flex items-center gap-2 px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700">
