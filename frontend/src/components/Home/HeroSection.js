...
//   return (
//     <section className="relative flex items-center justify-center min-h-[90vh] w-full bg-gradient-to-b from-green-50 to-green-100 overflow-hidden">
//       <div className="w-full h-full px-3 xs:px-4 sm:px-6 md:px-8 lg:px-16 flex items-start justify-center py-8 sm:py-12">
//         <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center w-full max-w-7xl">
//           {/* Left: Text Content */}
//           <motion.div
//             className="md:-ml-4"
//             initial={{ opacity: 0, x: -50 }}
...
//           >
//             <motion.h1
//               className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-800 mb-6 md:mb-8 leading-tight"
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.2, duration: 0.8 }}
//             >
//               Clean Communities,
//               <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent block mt-2 md:mt-4">
//                 Brighter Future
//               </span>
//             </motion.h1>

//             <motion.p
//               className="text-base xs:text-lg sm:text-xl text-gray-600 mb-8 md:mb-12 max-w-lg leading-relaxed"
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.4, duration: 0.8 }}
//             >
...
//             {/* Stats - Fixed for mobile S */}
//             <motion.div
//               className="flex justify-between items-center gap-2 xs:gap-3 sm:gap-4 md:gap-6 lg:gap-8"
//               initial={{ opacity: 0 }}
//               animate={{ opacity: 1 }}
//               transition={{ delay: 0.8, duration: 0.8 }}
//             >
//               <div className="text-center flex-1 min-w-0">
//                 <div className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold text-green-600 leading-tight">
//                   {counters.issuesResolved.toLocaleString()}+
//                 </div>
//                 <div className="text-[10px] xs:text-xs sm:text-sm text-gray-600 mt-1 leading-tight whitespace-nowrap overflow-hidden text-ellipsis">
//                   Issues Resolved
//                 </div>
//               </div>
...
//               />
//               <motion.div
//                 className="absolute -bottom-3 -right-3 xs:-bottom-4 xs:-right-4 sm:-bottom-6 sm:-right-6 bg-white rounded-xl xs:rounded-2xl shadow-xl p-3 xs:p-4 sm:p-6"
//                 initial={{ opacity: 0, scale: 0 }}
//                 animate={{ opacity: 1, scale: 1 }}
//                 transition={{ delay: 1, duration: 0.5 }}
//               >
//                 <div className="text-lg xs:text-xl sm:text-2xl md:text-3xl font-bold text-green-600">2.4K+</div>
//                 <div className="text-[10px] xs:text-xs sm:text-sm text-gray-600">Active Users</div>
//               </motion.div>
//             </motion.div>
//           </motion.div>
//         </div>
      ...
      <div className="w-full h-full px-3 xs:px-4 sm:px-6 md:px-8 lg:px-16 flex items-start justify-center py-8 sm:py-12">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center w-full max-w-7xl">
          ...
          >
            ...
            {/* Stats - Fixed spacing for tablet */}
            <motion.div
              className="flex justify-between items-center gap-3 xs:gap-4 sm:gap-6 md:gap-8 lg:gap-12"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.8, duration: 0.8 }}
            >
              <div className="text-center flex-1 min-w-0 px-1">
                <div className="text-xl xs:text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-green-600 leading-tight">
                  {counters.issuesResolved.toLocaleString()}+
                </div>
                <div className="text-[10px] xs:text-xs sm:text-sm text-gray-600 mt-1 leading-tight whitespace-nowrap">
                  Issues Resolved
                </div>
              </div>
