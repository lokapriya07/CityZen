...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className="bg-gray-900 text-gray-300 pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Empowering communities to create cleaner, healthier environments through citizen-driven waste management solutions.
            </p>
              ...
              <ul className="space-y-3">
                {links.map((link, linkIndex) => (
                  <motion.li key={linkIndex}>
                    <a href="#" className="text-gray-400 hover:text-green-500 transition-colors duration-300 inline-block relative group">
                      {link}
                      <motion.span
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © 2025 CityZen Clean. All rights reserved. Built with 💚 for our planet.
            </p>
