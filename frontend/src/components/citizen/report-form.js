...
export function ReportForm({ onSubmit, isSubmitting }) {
    ...
    const initialFormData = {
        fullName: '', email: '', phone: '', altPhone: '', address: '', city: '',
        pincode: '', state: '', gpsLocation: false, 
        // =================================================================
        // ✅ START: FIX 1 - Set initial value to null
        // =================================================================
        gpsCoordinates: null,
        // =================================================================
        // ✅ END: FIX 1
    ...
    const handleGpsToggle = (e) => {
        ...
        if (isChecked) {
                    ...
                    try {
                        ...
                        if (data && data.address) {
                            ...
                            setFormData(prev => ({
                                ...
                                state: addr.state || '',
                                // =================================================================
                                // ✅ START: FIX 2 - Save as an object { lat, lng }
                                // =================================================================
                        ...
                        setLocationStatus("❌ Could not fetch address. Please enter it manually.");
                        // =================================================================
                        // ✅ START: FIX 3 - Save as an object even if geocoding fails
                        // =================================================================
                        setFormData(prev => ({ 
                            ...prev, 
                            gpsCoordinates: { lat: latitude, lng: longitude }
            ...
            // =================================================================
            // ✅ START: FIX 4 - Set to null when checkbox is unchecked
            // =================================================================
