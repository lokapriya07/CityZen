...
// import { ReportIssue } from "./report-issue"; // Add this import
...
//               variant="outline"
//               className="justify-start bg-transparent"
//               onClick={() => setShowMessaging(true)} // Changed from setShowMessageModal
//             >
//               💬 Send Message
//             </Button>

//             {/* Call Support */}
//             {/* Call Support - UPDATED */}
//             <Button
//               variant="outline"
//               className="justify-start bg-transparent"
//               onClick={() => setShowCallSupport(true)} // Remove the old onClick logic
//             >
//               📞 Call Support
//             </Button>

//             {/* Share Location */}
//             {/* Share Location - UPDATED */}
//             <Button
//               variant="outline"
//               className="justify-start bg-transparent"
//               onClick={() => setShowShareLocation(true)} // Remove the old onClick logic
//             >
//               📍 Share Location
//             </Button>

//             {/* Report Issue */}
//             {/* Report Issue - UPDATED */}
//             <Button
//               variant="outline"
//               className="justify-start bg-transparent"
//               onClick={() => setShowReportIssue(true)} // Changed from setShowReportModal
//             >
//               ⚠️ Report Issue
//             </Button>
//           </div>
...
//           {/* --- Message Modal --- */}
//           {/* Worker Messaging Component - REPLACED MESSAGE MODAL */}
...
//                     phone: complaint.worker.contact,
...
//           )}
//           {/* --- Report Modal --- */}
//          {/* Report Issue Component - REPLACED REPORT MODAL */}
//           {showReportIssue && (
//             <ReportIssue
//               complaint={complaint}
...
//                   const response = await fetch(`/api/reports/${complaint.id}/call-log`, {
//                     method: "POST",
//                     headers: {
//                       "Content-Type": "application/json",
//                       "Authorization": `Bearer ${token}`,
...
//                   if (!response.ok) {
//                     console.warn("Failed to log call attempt");
//                   }

//                   return true;
//                 } catch (error) {
//                   console.error("Error logging call:", error);
//                   // Don't throw error here as we still want the call to proceed
//                   return true;
//                 }
//               }}
//             />
...
export function ComplaintTracker({ complaint }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ⚡ Quick Actions - Only show if worker is assigned */}
      {isWorkerAssigned && (
        <Card>
          <CardHeader>
            <CardTitle>Quick Actions</CardTitle>
